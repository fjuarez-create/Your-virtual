...
Visor 3D de venta del Edificio Apolo (166 viviendas, GILMAR). Dos visores web
en three.js (`/` clásico y `/new`), un panel de gestión en PHP 5.6 en
`gestion/`, y un proyecto de Unreal 5.8 aparte que se entrega como ejecutable
para la oficina de ventas.
...
- El rendimiento en iPhone es requisito en los dos visores web.
- `new/unreal.html` (la interfaz para el ejecutable de Unreal) se genera con
...
- `new/js/visor/CONTRATO.md` — contrato interno del visor nuevo.

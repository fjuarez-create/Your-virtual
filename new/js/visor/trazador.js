...
const FUNDIDO_MS = 1200;    // raster → trazado (largo, para que el grano no salte a la vista)
...
export function crearTrazador(ctx, luz, opciones = {}) {
  ...
  pt.minSamples = 48;   // política visual: nada de imagen granulada; el trazado solo asoma ya convergido
